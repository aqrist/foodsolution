...
<h1>
    Manajemen Varian
    <small>Halaman manajemen varian pada prooduk</small>
</h1>
<ol class="breadcrumb">
    <li><a href="{{ route('beranda_admin') }}"><i class="fa fa-home"></i> Beranda</a></li>
    <li><i class="fa fa-cubes fa-fw"></i> Produk</li>
    <li class="active"><i class="fa fa-clipboard fa-fw"></i> Varian</li>
</ol>
@endsection
    ...
    <div class="col-md-6 col-sm-12">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">
                    Form Input Varian Produk
                </h3>
            </div>
            {!! Form::open(['route' => 'tambah_varian']) !!}
                @csrf
                <div class="box-body">
                    <div class="form-group has-feedback">
                        {!! Form::label('inp_nama_varian', 'Nama Varian') !!}
                        {!! Form::text('nama_varian', null, ['id' => 'inp_nama_varian', 'class' => 'form-control']) !!}
                        <span class="help-block">Silahkan masukan varian produk</span>
                    </div>
                    <div class="form-group has-feedback">
